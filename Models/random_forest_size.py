...
setup_logging(logs_path, "random_forest_size.log")
logging.info("Starting the Random Forest model training for predicting size...".upper())
...
# Save Model
model_path = os.path.join(models_path, "random_forest_size.pkl")
...
validation_features = VALIDATION_DATA.drop(columns=["SIZE"], errors="ignore")
validation_targets = VALIDATION_DATA[["SIZE"]]
