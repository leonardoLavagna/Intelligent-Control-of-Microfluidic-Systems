...
logging.info(f"Starting the XGBoost model training process for predicting {target_variable}...".upper())
...
def run_model(seed, best_model_info):
    logging.info(f"Starting the XGBoost model training process for seed {seed}...".upper())
