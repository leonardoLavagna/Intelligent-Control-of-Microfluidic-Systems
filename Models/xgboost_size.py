...
setup_logging(logs_path, "xgboost_size.log")


logging.info("Starting the XGBoost model training process for predicting SIZE...".upper())
...
# Save the model
model_path = os.path.join(models_path, "xgboost_size.pkl")
