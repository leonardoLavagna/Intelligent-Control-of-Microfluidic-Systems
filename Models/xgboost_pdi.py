...
setup_logging(logs_path, "xgboost_pdi.log")


logging.info("Starting the XGBoost model training process for predicting PDI...".upper())
...
# Save the model
model_path = os.path.join(models_path, "xgboost_pdi.pkl")
